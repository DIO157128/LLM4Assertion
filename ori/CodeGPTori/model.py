...
class Seq2Seq(nn.Module):
    ...
    def __init__(self, decoder, config, beam_size=None, \
    ...
    def forward(self, inputs=None, labels=None, attn_mask=None, \
                loss_mask=None, pred=False):
        if not pred:
...
class Beam(object):
    def __init__(self, size, sos, eos):
        ...
        self.nextYs = [
            self.tt.LongTensor(size).fill_(0)
        ]
        self.nextYs[0][0] = sos
